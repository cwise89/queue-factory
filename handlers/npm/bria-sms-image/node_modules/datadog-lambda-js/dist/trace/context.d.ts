...
export declare function readTraceFromStepFunctionsContext(stepFunctionContext: StepFunctionContext): TraceContext | undefined;
export declare function hexToBinary(hex: string): string;
export declare function deterministicMd5HashInBinary(s: string): string;
export declare function deterministicMd5HashToBigIntString(s: string): string;
/**
